...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2015 a las 07:57:45
...
CREATE TABLE IF NOT EXISTS `estdo_investigador` (
...
CREATE TABLE IF NOT EXISTS `investigador_has_articulo` (
...
CREATE TABLE IF NOT EXISTS `investigador_has_grupos_investigacion` (
  `investigador_cedula` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `libro_has_investigador` (
...
CREATE TABLE IF NOT EXISTS `ponencias_has_investigador` (
...
ALTER TABLE `articulo`
 ADD PRIMARY KEY (`idarticulo`), ADD KEY `fk_articulo_revista1_idx` (`revista_idrevista`);
...
--
ALTER TABLE `evento`
 ADD PRIMARY KEY (`idevento`), ADD KEY `fk_evento_tipo_evento_idx` (`tipo_evento_idtipo_evento`);
...
ALTER TABLE `grupos_investigacion`
 ADD PRIMARY KEY (`idgrupos_investigacion`), ADD KEY `fk_grupos_investigacion_tipo_categoria1_idx` (`tipo_categoria_idtipo_categoria`);

--
-- Indices de la tabla `investigador`
--
ALTER TABLE `investigador`
 ADD PRIMARY KEY (`cedula`), ADD KEY `fk_investigador_estdo_investigador1_idx` (`estdo_investigador_idestdo_Investigador`), ADD KEY `fk_investigador_formacion_academica1_idx` (`formacion_academica_idformacion_academica`);

--
-- Indices de la tabla `investigador_has_articulo`
--
ALTER TABLE `investigador_has_articulo`
 ADD PRIMARY KEY (`investigador_cedula`,`articulo_idarticulo`), ADD KEY `fk_investigador_has_articulo_articulo1_idx` (`articulo_idarticulo`), ADD KEY `fk_investigador_has_articulo_investigador1_idx` (`investigador_cedula`);

--
-- Indices de la tabla `investigador_has_grupos_investigacion`
--
ALTER TABLE `investigador_has_grupos_investigacion`
 ADD PRIMARY KEY (`investigador_cedula`,`grupos_investigacion_idgrupos_investigacion`), ADD KEY `fk_investigador_has_grupos_investigacion_grupos_investigaci_idx` (`grupos_investigacion_idgrupos_investigacion`), ADD KEY `fk_investigador_has_grupos_investigacion_investigador1_idx` (`investigador_cedula`);

--
-- Indices de la tabla `libro`
--
ALTER TABLE `libro`
 ADD PRIMARY KEY (`idlibros`), ADD KEY `fk_libro_editorial1_idx` (`editorial_ideditorial`);

--
-- Indices de la tabla `libro_has_investigador`
--
ALTER TABLE `libro_has_investigador`
 ADD PRIMARY KEY (`libro_idlibros`,`investigador_cedula`), ADD KEY `fk_libro_has_investigador_investigador1_idx` (`investigador_cedula`), ADD KEY `fk_libro_has_investigador_libro1_idx` (`libro_idlibros`);

--
-- Indices de la tabla `ponencias`
--
ALTER TABLE `ponencias`
 ADD PRIMARY KEY (`idponencias`), ADD KEY `fk_ponencias_evento1_idx` (`evento_idevento`);

--
-- Indices de la tabla `ponencias_has_investigador`
--
ALTER TABLE `ponencias_has_investigador`
 ADD PRIMARY KEY (`ponencias_idponencias`,`investigador_cedula`), ADD KEY `fk_ponencias_has_investigador_investigador1_idx` (`investigador_cedula`), ADD KEY `fk_ponencias_has_investigador_ponencias1_idx` (`ponencias_idponencias`);
...
--
ALTER TABLE `grupos_investigacion`
MODIFY `idgrupos_investigacion` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tipo_categoria`
MODIFY `idtipo_categoria` int(11) NOT NULL AUTO_INCREMENT;
--
