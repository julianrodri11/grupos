...
import Beans.InvestigadorFacade;
...
public class InvestigadorController implements Serializable {
    ...
    @EJB
    private Beans.InvestigadorFacade ejbFacade;
    private List<Investigador> items = null;
    private Investigador selected;
    ...
    public void setSelected(Investigador selected) {
    ...
    public Investigador prepareCreate() {
        selected = new Investigador();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("InvestigadorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("InvestigadorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("InvestigadorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Investigador> getItems() {
        if (items == null) {
    ...
    public List<Investigador> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Investigador> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
