...
import Beans.FormacionAcademicaFacade;
...
@ManagedBean(name = "formacionAcademicaController")
@SessionScoped
public class FormacionAcademicaController implements Serializable {

    @EJB
    private Beans.FormacionAcademicaFacade ejbFacade;
    ...
    public static class FormacionAcademicaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof FormacionAcademica) {
                ...
                return getStringKey(o.getIdformacionAcademica());
            } else {
